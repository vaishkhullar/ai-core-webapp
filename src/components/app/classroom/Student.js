...
import LobbySwitch from "../../classroom/LobbySwitch"
import sound from "../../classroom/sounds/time-is-now.mp3"
...
export default class Student extends Component {
    ...
    sync = async ()=>{ // keep everyone in the group in sync by ensuring that we are viewing all those who are viewing us
        if (this.state.lobby_state) {
            ...
            console.log('user-id-1:', response.members['user-id-1'])
            console.log('user-id-2:', response.members['user-id-2'])
